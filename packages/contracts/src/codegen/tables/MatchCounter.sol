...
library MatchCounter {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "MatchCounter", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746200000000000000000000000000004d61746368436f756e74657200000000);
